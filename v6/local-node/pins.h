...
//
//  v6 NOTE: the floats, flow and pressure sensors now live on the TANK
//  NODE (ESP8266) and arrive over ESP-NOW. The pin defines below for
//  FLOAT_25/50/75/100, FLOW and the pressure ADC (GPIO34) are therefore
//  UNUSED on this node and free for future expansion. They are kept here
//  for reference and to avoid churn in shared headers.
// ============================================================

// Tank floats — v6: UNUSED (sourced from tank node via link). Free GPIOs.
#define PIN_FLOAT_25     32
#define PIN_FLOAT_50     33
#define PIN_FLOAT_75     25
#define PIN_FLOAT_100    26

// Flow sensor (YF-S201) — v6: UNUSED (sourced from tank node via link). Free GPIO.
#define PIN_FLOW         27
